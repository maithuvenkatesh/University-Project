...
''' Regression Experiment: Using Average of Past Performance '''
...
def main():
    ...
    # Cross-validation
    cv_scores_98 = cross_validation.cross_val_score(regr98, np.array(horses_98_X_train), np.array(horses_98_y_train), scoring='r2', cv=5)
    ...
    # Cross-validation
    cv_scores_05 = cross_validation.cross_val_score(regr05, np.array(horses_05_X_train), np.array(horses_05_y_train), scoring='r2', cv=5)
